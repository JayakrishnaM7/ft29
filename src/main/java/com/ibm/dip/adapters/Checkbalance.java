...
@Component
public class Checkbalance implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private CheckBalanceRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Checkbalance.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Checkbalance.class.getName());
         }else{
