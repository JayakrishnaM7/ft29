...
@Component
public class Getaccdetails implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private GetaccountdetailsRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Getaccdetails.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Getaccdetails.class.getName());
         }else{
